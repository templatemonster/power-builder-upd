<?php
/*
 * Plugin Name: Power Builder UPD
 * Plugin URI: https://github.com/templatemonster/power-builder-upd
...
defined( 'TM_BUILDER_VERSION' ) or define( 'TM_BUILDER_VERSION', '0.0.1' );
